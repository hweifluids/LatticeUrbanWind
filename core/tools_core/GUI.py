...
SCHEMA_ORDER = [
    ...
    FieldSpec("vk_inlet_enable", "VK inlet enable", "Numerical Control", "bool", quoted=False),
    FieldSpec("vk_inlet_ti", "VK turbulence intensity", "Numerical Control", "float", quoted=False),
    FieldSpec("vk_inlet_sigma", "VK sigma (m/s)", "Numerical Control", "float", quoted=False),
    FieldSpec("vk_inlet_L", "VK length scale (m)", "Numerical Control", "float", quoted=False),
    FieldSpec("vk_inlet_nmodes", "VK mode count", "Numerical Control", "int", quoted=False),
    FieldSpec("vk_inlet_seed", "VK random seed", "Numerical Control", "int", quoted=False),
    FieldSpec("vk_inlet_update_stride", "VK update stride", "Numerical Control", "int", quoted=False),
    FieldSpec("vk_inlet_uc_mode", "VK Uc mode", "Numerical Control", "str", quoted=False),
    FieldSpec("vk_inlet_same_realization_all_faces", "VK same realization all faces", "Numerical Control", "bool", quoted=False),
    FieldSpec("vk_inlet_stride_interpolation", "VK stride interpolation", "Numerical Control", "bool", quoted=False),
    FieldSpec("vk_inlet_inflow_only", "VK inflow-only filter", "Numerical Control", "bool", quoted=False),
    ...
    FieldSpec("unsteady_output", "Unsteady u VTK interval", "Numerical Control", "int", quoted=False),
